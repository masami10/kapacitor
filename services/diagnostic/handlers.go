...
func (h *DingdingHandler) Error(msg string, err error) {
	h.l.Error(msg, Error(err))
}

func (h *DingdingHandler) WithContext(ctx ...keyvalue.T) dingding.Diagnostic {
	fields := logFieldsFromContext(ctx)
...
type IotseedHandler struct {
	l Logger
}

func (h *IotseedHandler) Error(msg string, err error) {
	h.l.Error(msg, Error(err))
}

func (h *IotseedHandler) WithContext(ctx ...keyvalue.T) iotseed.Diagnostic {
	fields := logFieldsFromContext(ctx)

	return &IotseedHandler{
		l: h.l.With(fields...),
	}
}
...
func (h *JiguangHandler) Error(msg string, err error) {
	h.l.Error(msg, Error(err))
}

func (h *JiguangHandler) WithContext(ctx ...keyvalue.T) jiguang.Diagnostic {
	fields := logFieldsFromContext(ctx)

	return &JiguangHandler{
		l: h.l.With(fields...),
	}
}
