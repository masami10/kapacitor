...
func (s *Service) NewDingdingHandler() *DingdingHandler {
	return &DingdingHandler{
		l: s.Logger.With(String("service", "dingding")),
	}
}

func (s *Service) NewJiguangHandler() *JiguangHandler {
	return &JiguangHandler{
		l: s.Logger.With(String("service", "jiguang")),
	}
}

func (s *Service) NewIotseedHandler() *IotseedHandler {
	return &IotseedHandler{
		l: s.Logger.With(String("service", "iotseed")),
	}
}
