...
type AlertNodeData struct {
	...
	// tick:ignore
	JiguangHandlers []*JiguangHandler `tick:"Jiguang" json:"jiguang"`
	...
	// tick:ignore
	DingDingHandlers []*DingDingHandler `tick:"Dingding" json:"dingding"`
...
func (a *AlertNodeData) Jiguang() *JiguangHandler {
...
type JiguangHandler struct {
	*AlertNodeData `json:"-"`
	...
	// A supplementary URL to show with your message
	AtPeopleOnIotseed string `json:"atPeopleOnIotseed"`
...
func (a *AlertNodeData) Dingding() *DingDingHandler {
...
// tick:embedded:AlertNode.Dingding
type DingDingHandler struct {
	*AlertNodeData `json:"-"`
	...
	AtPeopleOnMobile string `json:"atPeopleOnMobile"`
